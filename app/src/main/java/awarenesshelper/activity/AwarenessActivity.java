...
public class AwarenessActivity extends Activity{
    ...
    public final void unsetSnapshot(SnapshotType snapshot) {
        switch (snapshot) {
            case PLACES:
                observationZone.setObservingPlaces(false);
                break;
            case WEATHER:
                observationZone.setObservingWeather(false);
                break;
            case LOCATION:
                observationZone.setObservingLocation(false);
                break;
            case BEACON_STATE:
                observationZone.setObservingBeaconState(false);
                break;
            case TIME_INTERVAL:
                observationZone.setObservingTimeInterval(false);
                break;
            case HEADPHONE_STATE:
                observationZone.setObservingHeadphoneState(false);
                break;
            case DETECTED_ACTIVITY:
                observationZone.setObservingDetectingActivity(false);
                break;
        }
    }

    /**
     * Unwatches ALL Snapshots
     */
    private final void resetObservation(){
        observationZone.unwatchAll();
    }
